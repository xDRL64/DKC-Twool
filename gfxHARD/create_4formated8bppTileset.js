...
(function(app=dkc2ldd){
	...
	app.gfx.fast.create_4formated8bppTileset = function(rawTileset){
		...
		for(let tOfst=0; tOfst<len; tOfst+=64){
			...
			n = t[0] = new Array(8); // tile row dimension
			...
			h = t[1] = new Array(8); // tile row dimension
			...
			v = t[2] = new Array(8); // tile row dimension
			...
			a = t[3] = new Array(8); // tile row dimension
...
for(let y=0; y<8; y++){
	...
	for(let x=0; x<8; x++){
		...
		str += `t[0] [${y}][${x}] = t[1] [${y}][${fx}] = t[2] [${fy}][${x}] = t[3] [${fy}][${fx}] = c;\n`;
	}
	str += '\n';
	o += 2;
}
...
/*
// NEW WAY currently used (tested : works!) //
// CREATE HARD CODE
let str = '';
let fx,fy, o=0;
