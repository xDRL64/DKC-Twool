...
(function(app=dkc2ldd){
	...
	app.gfx.fast.create_mapchipGfxBuffer_OLD_1 = function(rawMapchip, _4formatedTileset, palettes){
		...
		for(let cOfst=0; cOfst<len; cOfst+=32,iChip++){
			...
			c=doc.createElement('canvas'); c.width=32; c.height=32;  nChip = o.n[iChip] = chip[0] = c.getContext('2d');
			c=doc.createElement('canvas'); c.width=32; c.height=32;  hChip = o.h[iChip] = chip[1] = c.getContext('2d');
			c=doc.createElement('canvas'); c.width=32; c.height=32;  vChip = o.v[iChip] = chip[2] = c.getContext('2d');
			c=doc.createElement('canvas'); c.width=32; c.height=32;  aChip = o.a[iChip] = chip[3] = c.getContext('2d');
...
// create_mapchipGfxBuffer_OLD_1 is faster than create_mapchipGfxBuffer_OLD_0
